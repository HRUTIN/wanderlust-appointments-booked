...
const HeroSection = () => {
  return (
    <div className="relative min-h-[40vh] bg-gradient-to-br from-sky-100 via-sky-200 to-sky-300 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[40vh] px-4 text-center">
        <div className="animate-fade-in">
          <div className="flex items-center justify-center mb-6">
            <Compass className="w-12 h-12 text-sky-700 mr-4 animate-pulse-soft" />
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-sky-900">
              Wanderlust Bookings
            </h1>
          </div>
          
          <p className="text-xl md:text-2xl text-sky-700 mb-8 max-w-2xl mx-auto leading-relaxed">
